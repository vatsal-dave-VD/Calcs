                ...
                <div className="row d-flex justify-content-center">
                    <div className="col-12">
                        ...
                        <div className="card bg-light m-4 border-dark" style={{border:"10px solid",borderRadius:"20px"}}>
                            ...
                            {/** Card Body */}
                            <h4 className="card-body p-5">
                                <u>Welcome => CALCs</u><br/><br/>
                                <center className="h4">THis is ! just simple calculator.</center><br/>
                                <p className="font-weight-normal h6">
                                    &lt;{/*{document.write}*/}Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse eu sem velit. 
                                    ...
                                    Vivamus blandit congue neque, et commodo est vehicula elementum. Integer vel ante enim. />
                                </p>
                                {/** Guest link */}
                                <p className="text-center m-0 p-0 mt-4">
                                    <i className="text-primary text-decoration-underline" onClick={()=>alert("GUEST USER!!")} style={{cursor:"pointer"}}>Click Here </i> to use as guest
                                </p>
                            </h4>
                        </div>
                    </div>
